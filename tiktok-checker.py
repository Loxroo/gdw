...
def vpn():
    ...
    if sendvpn.status_code == 404:
        wacn(f"{Fore.LIGHTGREEN_EX}you are not banned.")
    else:
        wacn(f"{Fore.LIGHTRED_EX}you are banned enable VPN.")
    exit()


def checksessionid():
    sessionid = input(f"{Fore.LIGHTWHITE_EX}put the session id: ")
    user = ""
    for i in range(8):
    ...
    if jsonsendchecksession == "" or "":
        wacn(f"{Style.BRIGHT}{Fore.LIGHTGREEN_EX}this session is not banned.")
    else:
        wacn(f"{Style.BRIGHT}{Fore.LIGHTRED_EX}this session id is banned.")
    exit()
...
def checkersession(sessionid, user, count):
    ...
    if jsonsendcheckersession == "" or "":
        print(f"{Style.BRIGHT}{Fore.LIGHTBLACK_EX}[{Fore.LIGHTYELLOW_EX}{count}{Fore.LIGHTBLACK_EX}] {Fore.LIGHTWHITE_EX}{user}: {Fore.LIGHTGREEN_EX}is available.")
        with open("found.txt", "a") as found:
            found.write(user + "\n")
    else:
        print(f"{Style.BRIGHT}{Fore.LIGHTBLACK_EX}[{Fore.LIGHTYELLOW_EX}{count}{Fore.LIGHTBLACK_EX}] {Fore.LIGHTWHITE_EX}{user}: {Fore.LIGHTRED_EX}is not available.")
...
{Style.BRIGHT}{Fore.LIGHTMAGENTA_EX}===========================================================
        {Style.BRIGHT}{Fore.LIGHTWHITE_EX}[1] check if you are banned.
        [2] check if session id is banned.
        [3] checker with session id.
        [4] checker without session id.
        {Style.BRIGHT}{Fore.LIGHTCYAN_EX}INSTAGRAM: @WACNS
        TELEGRAM : @WACNS
        CHANNEL  : @WACNSS
{Style.BRIGHT}{Fore.LIGHTMAGENTA_EX}===========================================================""")
...
if choose == "1":
    ...
    if lastchoice == "1":
        ...
        fileinput = input(f"{Style.BRIGHT}{Fore.LIGHTWHITE_EX}enter file name: ").strip()
        wacn(f"{Style.BRIGHT}{Fore.LIGHTMAGENTA_EX}===========================================================")
